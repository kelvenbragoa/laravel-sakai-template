<template>
    ...
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span className="block text-500 font-medium mb-3">Exceções Pendentes</span>
    ...
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span className="block text-500 font-medium mb-3">Total de Transações</span>
    ...
    <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
            <div class="flex justify-between mb-4">
                <div>
                    <span className="block text-500 font-medium mb-3">Movimentações (Tally)</span>
