          ...
          >
            ...
            <div>
              ...
              <InputText
                ...
                type="text"
                placeholder="Usuário"
                class="w-full md:w-[30rem] mb-8 inputsCaixas"
              ...
              <Password
                id="password1"
                v-model="dadosUserAuth.password"
                placeholder="Senha"
                :toggleMask="true"
                class="mb-4 inputsCaixas"
                fluid
                :feedback="false"
              ></Password>
              ...
              <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                ...
                <span
                  class="font-medium no-underline ml-2 text-right cursor-pointer corPrimaria"
                  >Esqueceste a senha?</span
                >
              </div>
              <Button
                label="Entrar"
                class="w-full facebook-button hover"
                @click="autenticar"
              ></Button
              >\
              <!-- as="router-link" -->
