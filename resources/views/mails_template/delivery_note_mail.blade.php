...
<img src="https://res.cloudinary.com/dnj59cxlq/image/upload/v1721225544/cdm/cdm-logo.jpg" alt="Company Logo" width="50" height="50" style="display: block;" />
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="padding: 30px 0; text-align: center;">
                            <h1 style="color: #333333; font-size: 24px; margin: 0;">C-GATE 2.0</h1>
                            <p style="color: #444444; font-size: 18px; line-height: 1.5; margin: 10px 0 0;">Delivery Note Creation Notification</p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding: 20px 20px 0px 0;">
                                        <h1 style="color: #333333; font-size: 24px; margin-bottom: 20px;">Dear collaborators,</h1>
                                        <p style="color: #666666; font-size: 16px; line-height: 1.5;">We are pleased to inform you that a new Delivery Note was received for the transaction: <span style="font-weight: bold;">{{$dn['transaction_number']}}</span>.</p>
                                    </td>
                                </tr>
        ...
        <tr>
            <td style="padding: 20px 20px 0 ; text-align: center; font-size: 12px; color: #444444;">
                <p>C-GATE 2.0 - by Application Development Department</p>
